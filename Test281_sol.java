...
distance [ 0 2 4 1 2 X ]
 ...
 기존의 0-2 거리가 5, 0-3-2 거리가 4 : 2까지의 거리를 4로 업뎃
 기존에 0-4 거리가 X, 0-3-4 거리가 2 : 4까지의 거리를 2로 업뎃
 3은 방문

 - 방문 안한거 중에 가장 짧은 거리 스폿 ? 1 
visited : 1
distance [ 0 2 4 1 2 X ]
 visited [ O O X O X X ]
 
 1을 거쳐서 갈 수 있는 곳은 + 미방문 지점 
 0-5 를 그대로 가나 1을 거쳐서 2로 가나 거리는 5로 동일하다 : 업데이터 안됨 
 
 - 방문 안한거 중에 가장 짧은 거리 스폿 ? 4
visited : 4
distance [ 0 2 3 1 2 4 ]
 visited [ O O X O O X ] 
 
 기존의 0-5 거리가 X, 헌데 0-4 까지의 거리가 2 , 거기에 4-5 까지 거리가 2 : 4 업뎃
 기존의 0-2 거리가 4 ( 0-3-2 ) , 헌데 0-4 까지의 거리가 2 , 4-2 거리가 1 : 3으로 업뎃
 
 - 방문 안한거 중에 가장 짧은 거리 스폿 ? 2
visited : 2
distance [ 0 2 3 1 2 4 ]
 visited [ O O O O O X ] 
...
"최종적으로는 시작지점에서 부터 해당 지점까지의 최단거리를 구하는 알고리즘" 
*/